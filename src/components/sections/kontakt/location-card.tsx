    ...
    >
      ...
      <div className="flex items-start gap-4">
        <div className="p-3 bg-[#1a1a1a]">
          <MapPin className="w-5 h-5 text-[#C4A77D]" />
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-[#5a5a5a]">
            <a href={`tel:${phone}`} className="flex items-center gap-2 hover:text-[#C4A77D] transition-colors">
        ...
        <Link 
          href="/salony"
          className="p-2 bg-[#F8F7F4] text-[#737373] hover:bg-[#C4A77D] hover:text-white transition-all opacity-0 group-hover:opacity-100"
        >
