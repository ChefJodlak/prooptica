...
// Animated version for Chrome/Firefox
function AnimatedPlaceholderPost({ 
  post,
  index,
  isInView
}: { 
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
        <Instagram className="w-10 h-10 text-[#E31F25]/40 group-hover:text-[#C13584]/60 transition-colors duration-500" />
...
// Static version for Safari (no animations)
function StaticPlaceholderPost({ 
  post 
}: { 
  post: typeof PLACEHOLDER_POSTS[0]
}) {
  return (
    <a
      ...
      className="group relative aspect-square overflow-hidden cursor-pointer transform-gpu"
    >
      <div className={`absolute inset-0 bg-gradient-to-br ${post.gradient} opacity-20 group-hover:opacity-30 transition-opacity duration-300`} />
      <div className="absolute inset-0 bg-[#f8f7f4]" />
      <div className={`absolute inset-0 bg-gradient-to-br ${post.gradient} opacity-10`} />
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
        <Instagram className="w-10 h-10 text-[#E31F25]/40 group-hover:text-[#C13584]/60 transition-colors duration-300" />
        <span className="text-[10px] tracking-[0.2em] text-[#999] uppercase group-hover:text-[#C13584]/80 transition-colors duration-300">
          Zobacz post
        </span>
      </div>
      <div className="absolute inset-0 bg-gradient-to-br from-[#833AB4]/90 via-[#C13584]/90 to-[#E1306C]/90 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
        <div className="flex flex-col items-center gap-2 text-white">
          <ExternalLink className="w-6 h-6" />
          <span className="text-xs font-medium">Otwórz Instagram</span>
        </div>
