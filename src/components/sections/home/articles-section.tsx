          ...
          <div>
            ...
            <h2 className="font-display text-[clamp(1.75rem,5vw,3.5rem)] font-light text-[#1a1a1a] leading-[1.1] tracking-[-0.02em]">
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-0.5 sm:-bottom-1 left-0 w-full h-[5px] sm:h-[6px]" viewBox="0 0 100 8" preserveAspectRatio="none">
        ...
        <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 flex flex-col">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
              <BookOpen className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-[#E31F25]" />
                ...
                <div key={article.id} className="transform-gpu">
                  <Link href={`/artykuly/${article.id}`} className="group flex gap-3 sm:gap-5">
                    ...
                    <div className="flex-1 py-0.5 sm:py-1">
                      ...
                      {/* Title */}
                      <h4 className="font-display text-sm sm:text-base lg:text-lg font-medium text-[#1a1a1a] leading-snug mb-1.5 sm:mb-2 group-hover:text-[#E31F25] transition-colors duration-200 line-clamp-2">
                        {article.title}
                      </h4>
            ...
            <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-[#e5e5e5]">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <div className="w-8 sm:w-10 h-px bg-[#1a1a1a]/30 group-hover:bg-[#E31F25] group-hover:w-12 sm:group-hover:w-14 transition-all duration-200" />
                  <ArrowRight className="w-4 h-4 text-[#1a1a1a]/50 group-hover:text-[#E31F25] group-hover:translate-x-1 transition-all duration-200" />
                </div>
              </Link>
            </div>
